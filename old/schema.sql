...
ALTER TABLE ONLY public.users_olds
    ADD CONSTRAINT users_olds_unique UNIQUE (user_id, old_slug, destroyed_at);
...
ALTER TABLE ONLY public.forms
    ADD CONSTRAINT fk_forms_created_by_user_id FOREIGN KEY (created_by_user_id) REFERENCES public.users(id);
