...
VALUES (:first-name, :last-name, :email, :username, :password)
RETURNING id, first_name, last_name, email, username, password, created_at, updated_at, destroyed_at
...
SELECT id, first_name, last_name, email, username, password, created_at, updated_at, destroyed_at
FROM users
WHERE id = :id::uuid
...
SELECT u.id, u.first_name, u.last_name, u.email, u.username, u.password, uo.role, uo.old_slug, u.created_at, u.updated_at, u.destroyed_at
FROM users u
